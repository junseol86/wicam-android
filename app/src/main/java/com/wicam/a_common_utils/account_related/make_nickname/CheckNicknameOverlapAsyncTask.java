 ...
 */
public class CheckNicknameOverlapAsyncTask extends AsyncTask<String, integer, String> {

    private MakeNicknameActivity makeNicknameActivity;

    public CheckNicknameOverlapAsyncTask(MakeNicknameActivity makeNicknameActivity) {
...
//        System.out.println(urls[0]);
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            makeNicknameActivity.overlapCheckResult(root.getInt("result"));
