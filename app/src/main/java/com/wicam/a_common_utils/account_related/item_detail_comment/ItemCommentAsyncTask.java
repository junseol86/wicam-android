 ...
 */
public class ItemCommentAsyncTask extends AsyncTask<String, integer, String> {

    DetailActivityWithCommentAndReport detailActivityWithCommentAndReport;
    ArrayList<ItemAndCommentData> detailAndCommentList;

    public ItemCommentAsyncTask(DetailActivityWithCommentAndReport detailActivityWithCommentAndReport, ArrayList<ItemAndCommentData> detailAndCommentList) {
            ...
            if (num_results != 0) {
                ...
                for (int i = 0; i < cmntArray.length(); i++) {
                    ...
                    detailAndCommentList.add(
                            new CommentData(cmnt.getString("item_comment_id"), cmnt.getString("item_id"), cmnt.getString("url_link"), cmnt.getString("comment"),
                                    cmnt.getString("writer_id"), cmnt.getString("writer_nickname"), cmnt.getString("write_time"),
                                    cmnt.getInt("likes"), cmnt.getInt("my_like"), cmnt.getInt("report"), cmnt.getInt("has_photo"),
                ...
                detailAndCommentList.add(new CommentData("", "", "", "", "", "", "", 0, 0, 0, 0, false, true));
