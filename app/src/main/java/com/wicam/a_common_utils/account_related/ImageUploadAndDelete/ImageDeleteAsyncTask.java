 ...
 */
public class ImageDeleteAsyncTask extends AsyncTask<String, integer, String> {

    ImageUploadingActivity imageUploadingActivity;

    public ImageDeleteAsyncTask(ImageUploadingActivity imageUploadingActivity) {
...
//        System.out.println(urls[0]);
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            if (root.getString("result").equalsIgnoreCase("success"))
