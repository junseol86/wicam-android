 ...
 */
public class DeleteCommentAsyncTask extends AsyncTask<String, integer, String> {

    DetailActivityWithCommentAndReport detailActivityWithCommentAndReport;

    public DeleteCommentAsyncTask(DetailActivityWithCommentAndReport detailActivityWithCommentAndReport) {
...
//        System.out.println(urls[0]);
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            detailActivityWithCommentAndReport.afterCommentWorkWithImage();
