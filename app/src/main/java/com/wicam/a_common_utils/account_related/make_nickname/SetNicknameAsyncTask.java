 ...
 */
public class SetNicknameAsyncTask extends AsyncTask<String, integer, String> {

    private MakeNicknameActivity makeNicknameActivity;

    public SetNicknameAsyncTask(MakeNicknameActivity makeNicknameActivity) {
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            if (root.getString("result").equalsIgnoreCase("true")) {
                makeNicknameActivity.goToNicknameNeededActivity(0);
            }
