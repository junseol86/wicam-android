 ...
 */
public class CustomDeleteAsyncTask extends AsyncTask<String, integer, String> {

    CustomDetailActivity customDetailActivity;

    public CustomDeleteAsyncTask(CustomDetailActivity customDetailActivity) {
        this.customDetailActivity = customDetailActivity;
    }
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            if (jo.getString("result").equalsIgnoreCase("success"))
                customDetailActivity.afterCustomDeleted();
