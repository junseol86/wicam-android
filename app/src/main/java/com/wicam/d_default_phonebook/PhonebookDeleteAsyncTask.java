 ...
 */
public class PhonebookDeleteAsyncTask extends AsyncTask<String, integer, String> {

    PhonebookDetailActivity phonebookDetailActivity;

    public PhonebookDeleteAsyncTask(PhonebookDetailActivity phonebookDetailActivity) {
        this.phonebookDetailActivity = phonebookDetailActivity;
    }
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            if (jo.getString("result").equalsIgnoreCase("success"))
                phonebookDetailActivity.afterPhonebookDeleted();
