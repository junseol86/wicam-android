 ...
 */
public class AdvertiseAddModifyAsyncTask extends AsyncTask<String, integer, String> {

    // 식당의 리스트, 상세 페이지는 사진댓글에 영향을 받으므로 댓글이 쓰이거나 지워질 때마다 업데이트

    AdvertiseAddModifyActivity advertiseAddModifyActivity;

    public AdvertiseAddModifyAsyncTask(AdvertiseAddModifyActivity advertiseAddModifyActivity) {
        this.advertiseAddModifyActivity = advertiseAddModifyActivity;
    }
...
//        System.out.println(urls[0]);
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            advertiseAddModifyActivity.addAdvertiseResult(jo.getString("result"));
