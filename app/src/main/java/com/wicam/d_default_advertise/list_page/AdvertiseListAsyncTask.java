 ...
 */
public class AdvertiseListAsyncTask extends AsyncTask<String, integer, String> {

    AdvertiseListActivity advertiseListActivity;
    ArrayList<ItemData> advertiseList;

    public AdvertiseListAsyncTask(AdvertiseListActivity advertiseListActivity, ArrayList<ItemData> advertiseList) {
        ...
        try{
            ...
            if (num_results != 0) {
                if (num_results <= (page+1)*unit) {
                    advertiseListActivity.setDownloadedAllInServer(true);
                }
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    advertiseList.add(new AdvertiseData(schoolIds, schoolNames,
                            jo.getString("advertise_id"), jo.getString("advertise_name"), jo.getString("kind"), jo.getString("url_link"), jo.getString("description"),
                ...
                advertiseList.add(new AdvertiseData(new ArrayList<String>(), new ArrayList<String>(),
                                                            "", "", "", "", "", "", "", "", "", "", "",
                                                            0,
                                                            0, 0, 0, 0, 0, 0,
            ...
            advertiseListActivity.showDownloadedList();
            advertiseListActivity.setDownloading(false);
