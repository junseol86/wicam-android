 ...
 */
public class DeliveryListAsyncTask extends AsyncTask<String, integer, String> {

    DeliveryListActivity deliveryListActivity;
    ArrayList<ItemData> deliveryList;

    public DeliveryListAsyncTask(DeliveryListActivity deliveryListActivity, ArrayList<ItemData> deliveryList) {
        ...
        try{
            ...
            if (num_results != 0) {
                if (num_results <= (page+1)*unit) {
                    deliveryListActivity.setDownloadedAllInServer(true);
                }
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    deliveryList.add(new DeliveryData(schoolIds, schoolNames,
                            jo.getString("delivery_id"), jo.getString("delivery_name"), jo.getString("includes"), jo.getString("delivery_condition"), jo.getString("description"),
                            jo.getString("menu"), jo.getString("phone1"), jo.getString("phone2"),
                ...
                deliveryList.add(new DeliveryData(new ArrayList<String>(), new ArrayList<String>(),
                                                            "", "", "", "", "", "", "", "", "", "", "", "",
                                                            0,
                                                            0, 0, 0, 0, 0, 0,
            ...
            deliveryListActivity.showDownloadedList();
            deliveryListActivity.setDownloading(false);
