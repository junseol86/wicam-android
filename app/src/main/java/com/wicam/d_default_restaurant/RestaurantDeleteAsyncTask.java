 ...
 */
public class RestaurantDeleteAsyncTask extends AsyncTask<String, integer, String> {

    RestaurantDetailActivity restaurantDetailActivity;

    public RestaurantDeleteAsyncTask(RestaurantDetailActivity restaurantDetailActivity) {
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            if (jo.getString("result").equalsIgnoreCase("success"))
                restaurantDetailActivity.afterRestaurantDeleted();
