 ...
 */
public class ContentDeleteAsyncTask extends AsyncTask<String, integer, String> {

    ContentDrawer contentDrawer;

    public ContentDeleteAsyncTask(ContentDrawer contentDrawer) {
...
//        System.out.println(urls[0]);
    ...
    protected void onPostExecute(String str) {
        try{
            ...
            if (root.getString("result").equalsIgnoreCase("done")) {
